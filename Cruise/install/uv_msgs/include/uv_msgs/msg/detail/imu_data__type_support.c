  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  uv_msgs__msg__ImuData__init(message_memory);
}

void ImuData__rosidl_typesupport_introspection_c__ImuData_fini_function(void * message_memory)
{
  uv_msgs__msg__ImuData__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember ImuData__rosidl_typesupport_introspection_c__ImuData_message_member_array[4] = {
  {
    "mode",  // name
    ...
    offsetof(uv_msgs__msg__ImuData, mode),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(uv_msgs__msg__ImuData, dvl),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(uv_msgs__msg__ImuData, pos),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(uv_msgs__msg__ImuData, spd),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
