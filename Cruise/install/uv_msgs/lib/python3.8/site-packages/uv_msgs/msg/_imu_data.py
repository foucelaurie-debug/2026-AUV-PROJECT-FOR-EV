...
class ImuData(metaclass=Metaclass_ImuData):
    ...
    def __init__(self, **kwargs):
        ...
        self.dvl = kwargs.get('dvl', int())
        from uv_msgs.msg import RobotAxis
        self.pos = kwargs.get('pos', RobotAxis())
        from uv_msgs.msg import RobotAxis
        self.spd = kwargs.get('spd', RobotAxis())
    ...
    def dvl(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'dvl' field must be of type 'int'"
            assert value >= 0 and value < 256, \
                "The 'dvl' field must be an unsigned integer in [0, 255]"
        self._dvl = value
    ...
    def spd(self, value):
        if __debug__:
            ...
            assert \
                isinstance(value, RobotAxis), \
                "The 'spd' field must be a sub message of type 'RobotAxis'"
        self._spd = value
