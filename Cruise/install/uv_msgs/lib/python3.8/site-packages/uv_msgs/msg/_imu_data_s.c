...
bool uv_msgs__msg__imu_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("uv_msgs.msg._imu_data.ImuData", full_classname_dest, 29) == 0);
  }
  uv_msgs__msg__ImuData * ros_message = _ros_message;
  {  // mode
  ...
  {  // dvl
    PyObject * field = PyObject_GetAttrString(_pymsg, "dvl");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->dvl = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // pos
  ...
  {  // spd
    ...
    if (!uv_msgs__msg__robot_axis__convert_from_py(field, &ros_message->spd)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * uv_msgs__msg__imu_data__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("uv_msgs.msg._imu_data");
  ...
  {  // dvl
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->dvl);
    {
      int rc = PyObject_SetAttrString(_pymessage, "dvl", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // spd
    PyObject * field = NULL;
    field = uv_msgs__msg__robot_axis__convert_to_py(&ros_message->spd);
    if (!field) {
      return NULL;
    }
    {
