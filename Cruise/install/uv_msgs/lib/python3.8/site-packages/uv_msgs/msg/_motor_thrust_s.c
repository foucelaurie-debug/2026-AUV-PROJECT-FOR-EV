...
bool uv_msgs__msg__motor_thrust__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("uv_msgs.msg._motor_thrust.MotorThrust", full_classname_dest, 37) == 0);
  }
  uv_msgs__msg__MotorThrust * ros_message = _ros_message;
  {  // thrust
...
{
  /* NOTE(esteve): Call constructor of MotorThrust */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("uv_msgs.msg._motor_thrust");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MotorThrust");
