...
bool uv_msgs__msg__pid_params__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("uv_msgs.msg._pid_params.PidParams", full_classname_dest, 33) == 0);
  }
  uv_msgs__msg__PidParams * ros_message = _ros_message;
  {  // name
...
PyObject * uv_msgs__msg__pid_params__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("uv_msgs.msg._pid_params");
