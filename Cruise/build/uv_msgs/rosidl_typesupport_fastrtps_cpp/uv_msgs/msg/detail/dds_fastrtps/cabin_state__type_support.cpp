...
#include "uv_msgs/msg/detail/cabin_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const uv_msgs::msg::CabinState & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  uv_msgs::msg::CabinState & ros_message)
{
  // Member: temp
  cdr >> ros_message.temp;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_uv_msgs
max_serialized_size_CabinState(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  auto typed_message =
    static_cast<const uv_msgs::msg::CabinState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<uv_msgs::msg::CabinState *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _CabinState__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const uv_msgs::msg::CabinState *>(
...
{
  return max_serialized_size_CabinState(full_bounded, 0);
}

static message_type_support_callbacks_t _CabinState__callbacks = {
  "uv_msgs::msg",
  "CabinState",
...
static rosidl_message_type_support_t _CabinState__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_CabinState__callbacks,
...
{
  return &uv_msgs::msg::typesupport_fastrtps_cpp::_CabinState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, uv_msgs, msg, CabinState)() {
  return &uv_msgs::msg::typesupport_fastrtps_cpp::_CabinState__handle;
}
