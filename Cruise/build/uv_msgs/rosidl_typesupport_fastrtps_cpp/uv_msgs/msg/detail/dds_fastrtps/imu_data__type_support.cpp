...
#include "uv_msgs/msg/detail/imu_data__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const uv_msgs::msg::ImuData & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  uv_msgs::msg::ImuData & ros_message)
{
  // Member: mode
  cdr >> ros_message.mode;
...
{
  auto typed_message =
    static_cast<const uv_msgs::msg::ImuData *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<uv_msgs::msg::ImuData *>(
    untyped_ros_message);
...
{
  return &uv_msgs::msg::typesupport_fastrtps_cpp::_ImuData__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, uv_msgs, msg, ImuData)() {
  return &uv_msgs::msg::typesupport_fastrtps_cpp::_ImuData__handle;
}
