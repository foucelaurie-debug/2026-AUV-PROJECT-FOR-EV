...
#include "uv_msgs/msg/detail/thrust_curve__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const uv_msgs::msg::ThrustCurve & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  uv_msgs::msg::ThrustCurve & ros_message)
{
  // Member: num
  cdr >> ros_message.num;
...
{
  auto typed_message =
    static_cast<const uv_msgs::msg::ThrustCurve *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<uv_msgs::msg::ThrustCurve *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ThrustCurve__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const uv_msgs::msg::ThrustCurve *>(
...
{
  return max_serialized_size_ThrustCurve(full_bounded, 0);
}

static message_type_support_callbacks_t _ThrustCurve__callbacks = {
  "uv_msgs::msg",
  "ThrustCurve",
...
static rosidl_message_type_support_t _ThrustCurve__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ThrustCurve__callbacks,
...
{
  return &uv_msgs::msg::typesupport_fastrtps_cpp::_ThrustCurve__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, uv_msgs, msg, ThrustCurve)() {
  return &uv_msgs::msg::typesupport_fastrtps_cpp::_ThrustCurve__handle;
}
