...
#include "uv_msgs/msg/detail/pid_params__rosidl_typesupport_fastrtps_c.h"
...
using _PidParams__ros_msg_type = uv_msgs__msg__PidParams;
...
static uint32_t _PidParams__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_uv_msgs__msg__PidParams(
...
{
  return max_serialized_size_uv_msgs__msg__PidParams(
    full_bounded, 0);
}
