...
static const _RobotAxis_type_support_symbol_names_t _RobotAxis_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, uv_msgs, msg, RobotAxis)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, uv_msgs, msg, RobotAxis)),
  }
};
...
{
  return &::uv_msgs::msg::rosidl_typesupport_cpp::RobotAxis_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, uv_msgs, msg, RobotAxis)() {
  return get_message_type_support_handle<uv_msgs::msg::RobotAxis>();
}
