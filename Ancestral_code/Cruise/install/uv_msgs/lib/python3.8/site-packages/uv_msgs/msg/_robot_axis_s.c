...
bool uv_msgs__msg__robot_axis__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("uv_msgs.msg._robot_axis.RobotAxis", full_classname_dest, 33) == 0);
  }
  uv_msgs__msg__RobotAxis * ros_message = _ros_message;
  {  // x
...
{
  /* NOTE(esteve): Call constructor of RobotAxis */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("uv_msgs.msg._robot_axis");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "RobotAxis");
