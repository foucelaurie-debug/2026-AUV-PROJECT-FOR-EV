...
{
  new (message_memory) uv_msgs::msg::ImuData(_init);
}

void ImuData_fini_function(void * message_memory)
{
  auto typed_message = static_cast<uv_msgs::msg::ImuData *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ImuData_message_member_array[4] = {
  {
    ...
    offsetof(uv_msgs::msg::ImuData, mode),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(uv_msgs::msg::ImuData, dvl),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(uv_msgs::msg::ImuData, pos),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(uv_msgs::msg::ImuData, spd),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
get_message_type_support_handle<uv_msgs::msg::ImuData>()
{
  return &::uv_msgs::msg::rosidl_typesupport_introspection_cpp::ImuData_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, uv_msgs, msg, ImuData)() {
  return &::uv_msgs::msg::rosidl_typesupport_introspection_cpp::ImuData_message_type_support_handle;
}
